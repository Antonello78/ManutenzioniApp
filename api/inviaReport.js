        ...
        const htmlContent = `
            ...
            <head>
                <style>
                    ...
                    /* Logo Header - Dimensioni Ridotte */
                    .logo-header { text-align: left; margin-bottom: 15px; padding-bottom: 10px; border-bottom: 1px solid #f1f5f9; }
                    .logo-image { height: 45px; width: auto; display: block; }

                    .intro-section { margin-bottom: 15px; border-bottom: 2px solid #f1f5f9; padding-bottom: 10px; }
                    .intro-section p { font-size: 14px; margin: 5px 0; color: #1e293b; }
                    
                    .document-box { border: 1px solid #e2e8f0; border-radius: 4px; overflow: hidden; background: #fff; }
                    .document-header { background: #1e40af; color: #ffffff; padding: 6px; text-align: center; }
                    .document-header h3 { margin: 0; font-size: 14px; text-transform: uppercase; }
                    ...
                    .doc-label { padding: 4px 0; font-size: 10px; color: #64748b; font-weight: bold; width: 40%; text-transform: uppercase; }
                    .doc-value { padding: 4px 0; font-size: 12px; color: #0f172a; text-align: right; font-weight: 600; }
                    
                    .section-header { font-size: 10px; font-weight: 800; color: #1e40af; text-transform: uppercase; margin-bottom: 3px; margin-top: 8px; }
                    .doc-longtext { background: #f8fafc; padding: 8px; border-radius: 4px; font-size: 12px; color: #334155; border: 1px solid #f1f5f9; font-style: italic; white-space: pre-wrap; margin-bottom: 6px; }
                    
                    .total-badge { background: #1e40af; color: white; padding: 12px; text-align: center; margin-top: 10px; border-radius: 4px; }
                    .total-badge span { display: block; font-size: 9px; text-transform: uppercase; opacity: 0.9; }
                    .total-badge strong { font-size: 22px; font-weight: 800; }
            ...
            <body>
                <div class="letter-container">
                    ...
                    <div class="intro-section">
                        ...
                        <p>Invio riepilogo tecnico intervento <strong>N° ${nIntervento}</strong> del <strong>${dataItaliana}</strong> - <strong>${istitutoCompleto}</strong>.</p>
                        <p>Restiamo a disposizione per ogni necessità. Cordiali saluti.</p>
